...
|  **Firestore** | banco de dados em tempo real, com regras de segurança escritas e testadas por coleção |
|  **Firebase Functions** | lógica de backend em TypeScript, disparada por eventos do banco de dados |
